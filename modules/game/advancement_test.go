...
func TestRunAdvancementFiltersRosterSource(t *testing.T) {
	...
	advancing, determinations, err := m.runAdvancementFilters(ctx, phase, "", teams)
	if err != nil {
...
func TestRunAdvancementFiltersRosterSourceNoFallback(t *testing.T) {
	...
	advancing, _, err := m.runAdvancementFilters(ctx, phase, "", teams)
	if err != nil {
		t.Fatalf("runAdvancementFilters: %v", err)
	}
	if len(advancing) != 0 {
...
func TestRunAdvancementFiltersRealSource(t *testing.T) {
	...
	_, _, err := m.runAdvancementFilters(ctx, phase, "", teams)
	if err != nil {
		t.Fatalf("runAdvancementFilters: %v", err)
	}
	if rec.calls != 1 {
...
func TestRunAdvancementFiltersUnregisteredFilter(t *testing.T) {
	...
	if _, _, err := m.runAdvancementFilters(ctx, phase, "", teams); err == nil {
